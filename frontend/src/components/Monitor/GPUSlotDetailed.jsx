    ...
    <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 hover:border-indigo-300 hover:shadow-md hover:bg-white transition-all group relative overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-3 relative z-10">
         <div className="flex items-center gap-2 min-w-0">
            <span className="text-xs font-bold text-slate-500 bg-white px-2 py-1 rounded border border-slate-200 group-hover:text-indigo-600 group-hover:border-indigo-200 transition-colors shrink-0">#{data.id}</span>
            <span className="text-xs font-bold text-slate-700 truncate" title={data.name}>{data.name}</span>
         </div>
      </div>
      ...
      <div className="space-y-3 relative z-10">
         ...
         <div className="flex flex-col gap-1">
            <div className="flex justify-between items-end">
                <span className="text-[10px] font-bold text-slate-400 uppercase">Core</span>
         ...
         <div className="flex flex-col gap-1">
            <div className="flex justify-between items-end">
                <span className="text-[10px] font-bold text-slate-400 uppercase">VRAM</span>
                <span className="text-[10px] font-bold text-slate-600">{data.memUsed}M <span className="text-slate-400 font-normal">/ {data.memTotal}M</span></span>
            </div>
            <div className="h-1.5 w-full bg-slate-200 rounded-full overflow-hidden">
         ...
         <div className="flex justify-between gap-1 pt-2 border-t border-slate-100 mt-2">
             {/* Power */}
             <div className="flex-1 flex flex-col items-center bg-amber-50/50 p-1 rounded border border-amber-100/50 min-w-0" title="Power Usage">
             ...
             {/* Fan */}
             <div className="flex-1 flex flex-col items-center bg-blue-50/50 p-1 rounded border border-blue-100/50 min-w-0" title="Fan Speed">
             ...
             {/* Temp */}
             <div className="flex-1 flex flex-col items-center bg-rose-50/50 p-1 rounded border border-rose-100/50 min-w-0" title="Temperature">
                ...
                <span className="text-xs font-mono font-bold text-slate-700">{data.temp}°</span>
             </div>
         </div>
      </div>
    </div>
