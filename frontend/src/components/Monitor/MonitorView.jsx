  ...
  return (
    ...
    >
      ...
      <motion.section 
        ...
        className="relative overflow-hidden rounded-3xl bg-white border border-slate-100 shadow-sm p-8 group"
      >
           ...
           <div className="flex items-center gap-6">
             ...
             <div>
               ...
               <p className="text-slate-500 text-sm md:text-base font-medium flex items-center gap-3 mt-2">
                 <span className="bg-slate-100 px-2 py-0.5 rounded-md text-slate-600">{stats.system.os}</span>
                 <span className="text-slate-300">|</span>
                 <span className="font-mono text-slate-500">{stats.system.kernel}</span>
               </p>
             </div>
           </div>
                  ...
                  {stats.disk.partitions.map((p) => {
                    ...
                    <div key={p.path}>
                      <div className="flex justify-between text-sm mb-2 font-semibold">
                          ...
                          <span className="text-slate-600">{Math.round(usage)}%</span>
                      </div>
